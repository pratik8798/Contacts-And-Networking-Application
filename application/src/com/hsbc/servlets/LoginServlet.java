	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (userList.size() == 0) {
			...
			if(flag) {
				...
				String todayInString =new SimpleDateFormat(pattern).format(new java.util.Date());
				String dobInString =new SimpleDateFormat(pattern).format(dob);
				
				System.out.println(dobInString+" "+todayInString); 
				
				if(dobInString.equals(todayInString))
				{
					System.out.println("Happy bday");
					obj.put("birthday", "Happy birthday");
				}
				else 
				{
					obj.put("birthday", "Not birthday");
					System.out.println("Not ur bday");
				}
